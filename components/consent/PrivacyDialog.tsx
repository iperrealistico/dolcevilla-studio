    ...
    >
      <div className="flex min-h-full items-center justify-center py-3 sm:py-4">
        <motion.section
          ...
          className="w-full max-w-2xl rounded-[var(--radius-frame)] border border-white/14 bg-[linear-gradient(145deg,rgba(28,22,18,0.96),rgba(44,34,28,0.94))] p-6 text-[var(--color-paper)] shadow-[0_30px_90px_rgba(7,5,4,0.4)] md:p-8"
        >
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-[var(--radius-pill)] border border-white/14 bg-[rgb(255_255_255_/_0.05)] transition hover:bg-[rgb(255_255_255_/_0.08)]"
            >
              <X size={18} />
            </button>
          </div>
