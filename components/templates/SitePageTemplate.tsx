          ...
          <Container className="grid gap-10 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)] lg:items-start xl:gap-14">
            <div className="space-y-8 lg:pr-4">
              ...
              {page.nextSteps.length ? (
                <div className="rounded-[var(--radius-card)] border border-[var(--color-line)] bg-[var(--surface-panel)] p-5 shadow-[var(--shadow-card)] md:p-6">
                  <p className="text-xs font-semibold tracking-[0.28em] text-[var(--color-mist)] uppercase">
                    What happens next
                  </p>
                  <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                    {page.nextSteps.map((step, index) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex h-11 w-11 items-center justify-center rounded-[var(--radius-pill)] bg-[var(--surface-subtle)] text-[var(--color-ink)]">
