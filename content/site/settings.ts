...
export const siteSettings = siteSettingsSchema.parse({
  ...
  defaultDescription:
    "Dolcevilla Studio is a Tuscany wedding photography studio based at Villa Raffaelli near Lucca, combining film craft, dependable digital coverage, and local guidance for destination weddings in Italy.",
