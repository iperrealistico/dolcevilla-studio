...
export function ConsentDoorway() {
  ...
  return (
    <div
      aria-modal="true"
      role="dialog"
      className="fixed inset-0 z-[70] grid place-items-center bg-[rgb(20_17_14_/_0.72)] p-5 backdrop-blur-sm"
    >
      <div className="w-full max-w-2xl rounded-[2rem] border border-white/12 bg-[linear-gradient(135deg,#1D1916,#4B4034)] px-6 py-8 text-[var(--color-paper)] shadow-2xl md:px-10 md:py-12">
