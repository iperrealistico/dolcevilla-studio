...
export function JournalEntryHero({
  ...
  const heroMetaChipClassName =
    "inline-flex items-center gap-2 rounded-[var(--radius-pill)] border border-[rgb(255_255_255_/_0.18)] bg-[linear-gradient(145deg,rgba(16,12,9,0.42),rgba(16,12,9,0.24))] px-3.5 py-2 text-[0.68rem] font-semibold tracking-[0.18em] text-[rgb(250_244_236)] uppercase shadow-[0_18px_42px_rgba(10,7,5,0.24)] ring-1 ring-[rgb(255_255_255_/_0.06)] backdrop-blur-md";

  return (
    <section className="px-4 pt-4 pb-4 md:px-8 md:pt-5 lg:px-10">
      <div className="relative mx-auto min-h-[clamp(23rem,88vw,28rem)] max-w-[var(--journal-frame-max)] overflow-hidden rounded-[var(--radius-frame)] border border-white/16 bg-[var(--color-shell)] shadow-[0_32px_88px_rgba(18,12,9,0.22)] md:min-h-[56svh]">
        <Image
          src={coverAsset.src}
          alt={coverAsset.alt}
          fill
        ...
        <Container className="relative z-10 flex min-h-[clamp(23rem,88vw,28rem)] flex-col justify-between px-0 py-0 md:min-h-[56svh] md:justify-end md:py-9">
          <div className="flex min-h-[clamp(23rem,88vw,28rem)] flex-col justify-between px-5 pt-5 pb-6 md:min-h-[56svh] md:px-0 md:pt-0 md:pb-0">
            ...
            <div className="max-w-4xl space-y-5 drop-shadow-[0_18px_38px_rgba(10,7,5,0.36)] md:space-y-6">
              <h1 className="font-display-face max-w-[9.4ch] text-[2.55rem] leading-[0.91] tracking-[-0.06em] text-[var(--color-paper)] [text-shadow:0_2px_6px_rgba(9,6,5,0.36),0_18px_42px_rgba(9,6,5,0.76)] sm:text-[3rem] md:max-w-4xl md:text-[5.35rem] md:leading-[0.9] md:tracking-[-0.062em]">
                {title}
              </h1>
