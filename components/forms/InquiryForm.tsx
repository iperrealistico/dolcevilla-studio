...
export function InquiryForm() {
  ...
  if (isSubmitted) {
    return (
      <div className="space-y-4 rounded-[var(--radius-frame)] border border-[var(--color-line)] bg-[var(--surface-panel)] p-6 shadow-[var(--shadow-card)] md:p-7">
  ...
  return (
    <form
      className="grid gap-5 rounded-[var(--radius-frame)] border border-[var(--color-line)] bg-[var(--surface-panel)] p-6 shadow-[var(--shadow-card)] md:p-7"
      onSubmit={onSubmit}
    >
