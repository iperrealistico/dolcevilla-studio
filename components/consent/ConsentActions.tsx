...
function PreferenceToggle({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className="flex w-full items-start justify-between gap-4 rounded-[var(--radius-card)] border border-white/12 bg-white/8 px-4 py-4 text-left transition hover:bg-white/12"
    >
      ...
      <span
        aria-hidden="true"
        className="relative mt-1 inline-flex h-7 w-12 shrink-0 rounded-[var(--radius-pill)] border border-white/18 bg-white/10 p-1 transition"
      >
        <span
          className="h-5 w-5 rounded-[var(--radius-pill)] bg-[var(--color-paper)] shadow-[0_8px_20px_rgba(10,8,6,0.25)] transition"
          style={{
...
export function ConsentActions() {
  ...
  return (
    <div className="relative grid min-h-[min(76dvh,720px)] overflow-hidden rounded-[var(--radius-frame)] border border-white/12 bg-[linear-gradient(140deg,#171311,#2d241e_42%,#43362d)] shadow-[0_40px_120px_rgba(17,12,8,0.48)] lg:grid-cols-[1.08fr_0.92fr]">
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            {consent.hasInteracted ? (
              <button
                ...
                className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-[var(--radius-pill)] border border-white/14 bg-[rgb(18_15_12_/_0.32)] text-[var(--color-paper)] transition hover:bg-[rgb(18_15_12_/_0.5)]"
              >
                <X size={18} />
              </button>
            ) : null}
        ...
        <div className="relative z-10">
          <div className="grid gap-3">
            <button
              type="button"
              onClick={acceptAll}
              className="w-full rounded-[var(--radius-card)] border border-[rgb(248_236_211_/_0.9)] bg-[linear-gradient(135deg,rgb(246_233_205),rgb(232_214_179))] px-5 py-5 text-left text-[var(--color-ink)] shadow-[0_26px_60px_rgba(12,8,4,0.22)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_30px_70px_rgba(12,8,4,0.28)]"
            >
              <div className="flex items-start justify-between gap-4">
                <div>
            ...
            <button
              ...
              className="w-full rounded-[var(--radius-card)] border border-white/12 bg-[rgb(255_255_255_/_0.05)] px-5 py-5 text-left transition hover:bg-[rgb(255_255_255_/_0.08)]"
            >
          ...
          <AnimatePresence initial={false}>
            {showPreferences ? (
              ...
              >
                <div className="space-y-3 rounded-[var(--radius-card)] border border-white/10 bg-[rgb(255_255_255_/_0.05)] p-4">
                  <PreferenceToggle
