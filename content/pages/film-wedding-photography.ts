...
export const filmWeddingPhotographyPage = servicePageContentSchema.parse({
  ...
  gallery: buildGallery([
    ...
    { id: "film8x10ViewCameraOliveGrove", layoutVariant: "portrait" },
    ...
    { id: "darkroomChemistryTraysHands", layoutVariant: "landscape" },
    { id: "darkroomEnlargerWorkbench", layoutVariant: "landscape" },
  ]),
  highlights: [
    {
