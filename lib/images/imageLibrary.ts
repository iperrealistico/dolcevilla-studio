...
export const imageAssetLibrary = {
  ...
  journalQuietLuxuryTuscanyCover: createAsset(
    "journal-quiet-luxury-tuscany-cover",
    "/images/brand/journal-generated/quiet-luxury-weddings-in-tuscany-venue-style-fashion-and-photography-tips-cover.png",
    "An elegantly dressed couple beneath a Tuscan loggia beside a quiet luxury dinner setting.",
    1693,
    929,
    "linen",
  ),
  journalQuietLuxuryTuscanyWash: createAsset(
    "journal-quiet-luxury-tuscany-wash",
    "/images/brand/journal-generated/quiet-luxury-weddings-in-tuscany-venue-style-fashion-and-photography-tips-ornament-wash.png",
    "An airy ornament of Tuscan arches, olive branches, ribbon, and floral forms on white.",
    1693,
    929,
    "linen",
  ),
  journalQuietLuxuryTuscanyOrbit: createAsset(
    "journal-quiet-luxury-tuscany-orbit",
    "/images/brand/journal-generated/quiet-luxury-weddings-in-tuscany-venue-style-fashion-and-photography-tips-ornament-orbit.png",
    "A graphic ornament of gold rings, ribbon, olive leaves, and a Tuscan arch on white.",
    1254,
    1254,
    "sage",
  ),
