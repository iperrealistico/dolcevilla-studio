  ...
  return (
    <>
      ...
      <div className="relative hidden h-full xl:block" ref={desktopTrackRef}>
        ...
        >
          <div className="flex max-h-[calc(100dvh-var(--site-header-height,76px)-2rem)] flex-col gap-3 rounded-[var(--radius-card)] border border-[var(--color-line)] bg-[var(--surface-panel-strong)] p-3.5 shadow-[var(--shadow-card)] backdrop-blur-md">
      ...
      >
        <div className="mx-auto max-w-[var(--container-max)] rounded-[var(--radius-card)] border border-[var(--color-line)] bg-[var(--surface-floating)] px-3 py-3 shadow-[var(--shadow-floating)] backdrop-blur-md">
